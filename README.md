...
1. I use some opinionated settings which will be outlines below...
...
1. `master` - Baseline, using `pdm` as a package manager, pytest/pytest-mock for testing + ruff/isort/pylance for linting
